     ...
     */
     ...
     function captcha($str)
     {
         ...
         for ($i = 0; $i < mb_strlen($gstr); $i++) {
             ...
             $tmp = imagettfbbox($fontsize, $text_info[$char]['angle'], realpath('../fonts/font.ttf'), $char);
         ...
         foreach ($text_info as $char => $info) {
             ...
             imagettftext($dst_img, $fontsize, $info['angle'], $x_pointer, $y, $colors[rand(0, count($colors) - 1)], realpath('../fonts/font.ttf'), $char);
     ...
     for ($i = 0; $i < 100; $i++) {
        $pixel_color = imagecolorallocate($dst_img, rand(0, 255), rand(0, 255), rand(0, 255));
        imagesetpixel($dst_img, rand(0, $dst_w), rand(0, $dst_h), $pixel_color);
    }
